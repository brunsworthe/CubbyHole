...
export default function LenticularViewer({ imageUrls }: Props) {
  ...
  // Zoom is purely a CSS scale on the frame-stack layer below — pointer-drag scrub reads
  // raw e.clientX deltas (screen space), so it's unaffected by this transform.
